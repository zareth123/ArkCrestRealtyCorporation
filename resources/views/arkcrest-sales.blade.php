...
<div class="arc-wrap">
    ...
    {{-- Header --}}
    <div style="background:linear-gradient(135deg,#1e4575 0%,#2563eb 60%,#1e4575 100%);border-radius:20px;padding:28px 32px;margin-bottom:24px;position:relative;overflow:hidden;box-shadow:0 8px 32px rgba(30,69,117,.25);">
        ...
        <div style="position:relative;z-index:2;">
            ...
            <h1 style="font-size:24px;font-weight:700;color:white;margin:0 0 6px;">ARC Sales</h1>
            <p style="font-size:13px;color:rgba(255,255,255,.75);margin:0;">ArkCrest commission income from released agent commissions</p>
        </div>
    </div>
