...
@section('content')
    <div class="crs-cert-page">
        ...
        <div class="crs-cert-frame">
            <iframe src="{{ route('agent-training.certificate.preview') }}" title="Certificate of Completion preview"></iframe>
        </div>
    </div>
    ...
    <style>
        ...
        .crs-cert-frame iframe { position: absolute; inset: 0; width: 100%; height: 100%; border: 0; }
    </style>
@endsection
